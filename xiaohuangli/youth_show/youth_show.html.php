    ...
    <div class="row">
      ...
      <div class="span8 pull-right">
        <div class="navbar">
          <div class="navbar-inner">
            <ul class="nav">
              ...
              <li class="active"><a href="../youth_show/">青年词库</a></li>
        ...
        <form class="form-inline">
          一共有<?php echo $counter_word_all; ?>个闭月羞花的风骚女人，客官你要
        ...
        <h3>下载</h3>
        <p>
          <a href="../backup_youth/" class="btn btn-success"><i class="icon-download-alt icon-white"></i> 下载整个词库</a>
        </p>
      </div>
    </div>
    <footer>
