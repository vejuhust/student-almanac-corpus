...
if (isset($_POST['newcontent']))
{
    ...
    {
        //查询是否重复语句
        $sql_query = 'select count(*) from studentwords.corpus
                      where content = :content';
        $s_query = $pdo->prepare($sql_query);
                    
        //插入新内容语句
        $sql_insert = 'insert into studentwords.corpus set
                       content = :word_new,
    ...
    {
        $error_message = 'Error adding student newcontent: ' . $e->getMessage();
